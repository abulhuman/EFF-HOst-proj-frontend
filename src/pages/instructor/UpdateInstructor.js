...
const Updateinstructor = () => {
  ...
  useEffect(() => {
    ;(async function () {
      const data = await instance.get(`/instructor/${params.id}`)
  ...
  const [date_of_certificate_concede, setdate_of_certificate_concede] =
    useState('')
  const [place_of_certificate_concede, setplace_of_certificate_concede] =
    useState('')
          ...
          <div className='space-y-3'>
            ...
            <div className='flex flex-row'>
              ...
              >
                ...
                {image && (
                  <img
                    src={image}
                    alt='profileimagehere'
                    className='h-full w-full object-cover'
                  />
                )}
              </div>{' '}
              <img
                className='pl-24 pt-2 h-36 '
            ...
            <div className='flex flex-col'>
              ...
              >
                ...
                <option value={data.gender} disabled hidden selected>
                  {data.gender}
                </option>
            ...
            <div className='flex flex-col'>
              ...
              <select
                ...
                id='education'
              >
                <option value={data.education} disabled hidden selected>
                  {data.education}
                </option>
              ...
              <div className='flex flex-col space-y-1 my-5'>
                ...
                <div className='flex flex-col space-y-1'>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setdate_of_certificate_concede(e.target.value)
                    }
                  />
                </div>
                <div className='flex flex-col sapce-y-1'>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setplace_of_certificate_concede(e.target.value)
                    }
                  />
                </div>
                <div className='flex flex-col space-y-1'>
        ...
        <div className='flex justify-end items-center space-x-2'>
          ...
          <button
            ...
            onClick={(e) => {
              ...
              instance.patch(`/editinstractor/${data._id}`, fd).then((res) => {
