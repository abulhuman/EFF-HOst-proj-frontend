  ...
  useEffect(() => {
    const feachData = async () => {
      ...
      if (mediumInstructor) {
        ff = [
          ...ff,
          ...data.data.paylaod.filter(
            (education) => education.educational_state === 'Medium Instructor'
          )
        ]
      }
      if (higherInstructor) {
        ff = [
          ...ff,
          ...data.data.paylaod.filter(
            (education) => education.educational_state === 'Higher Instructor',
      ...
      if (CAFDInstructor) {
        ff = [
          ...ff,
          ...data.data.paylaod.filter(
            (education) => education.educational_state === 'CAF D Instructor',
            console.log(education.education)
          )
        ]
      }
      if (CAFCInstructor) {
        ff = [
          ...ff,
          ...data.data.paylaod.filter(
            (education) => education.educational_state === 'CAF C Instructor',
            console.log(education.education)
          )
        ]
      }
      if (CAFBInstructor) {
        ff = [
          ...ff,
          ...data.data.paylaod.filter(
            (education) => education.educational_state === 'CAF B Instructor',
            console.log(education.education)
          )
        ]
        // console.log(education.education);
      ...
      if (CAFAInstructor) {
        ff = [
          ...ff,
          ...data.data.paylaod.filter(
            (education) => education.educational_state === 'CAF A Instructor',
            console.log(education.education)
          )
        ]
        // console.log(education.education);
      ...
      if (CAFPROInstructor) {
        ff = [
          ...ff,
          ...data.data.paylaod.filter(
            (education) => education.educational_state === 'CAF Pro Instructor',
            console.log(education.education)
          )
        ]
        // console.log(education.education);
      ...
      if (fIfaInstractor) {
        ff = [
          ...ff,
          ...data.data.paylaod.filter(
            (education) => education.educational_state === 'FIFA Instructor'
          )
        ]
      }
      // if (fIfaInstractor) {
        ...
        <div className='bg-white p-7 shadow-lg rounded-lg'>
          <div className='my-2'>
            ...
            <div className='px-2 py-2 my-4 border rounded-md shadow-sm flex space-x-2 w-fit mb-8'>
              <Checkbox onChange={(e) => handleMediumInstructor()}>
                Medium Instructor
              </Checkbox>
              <Checkbox
                name='freelance'
                onChange={(e) => handlehigherInstructor()}
              >
                Higher Instructor
              </Checkbox>
              ...
              <Checkbox
                name='freelance'
                onChange={(e) => handleCAFDInstructor()}
              >
                CAF D Instructor
              </Checkbox>
              <Checkbox onChange={(e) => handleCAFCInstructor()}>
                CAF C Instructor
              </Checkbox>

              <Checkbox onChange={(e) => handleCAFBInstructor()}>
                CAF B Instructor
              </Checkbox>
              <Checkbox onChange={(e) => handleCAFAInstructor()}>
                CAF A Instructor
              </Checkbox>
              <Checkbox onChange={(e) => handleCAFPROInstructor()}>
                CAF PRO Instructor
              </Checkbox>
              <Checkbox onChange={(e) => handleFifaInstructor()}>
                FIFA Instractor
              </Checkbox>
            </div>
          </div>
