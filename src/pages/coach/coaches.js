    ...
    const feachData = async () => {
      ...
      if (firstLevel) {
        ff = [
          ...
          ...data.data.paylaod.filter(
            (education) => education.educational_state === 'First Level',
      ...
      if (secondLevel) {
        ff = [
          ...ff,
          ...data.data.paylaod.filter(
            (education) => education.educational_state === 'Second Level',
            console.log(education.education)
          )
        ]
      }
      if (CAFDCoach) {
        ff = [
          ...ff,
          ...data.data.paylaod.filter(
            (education) => education.educational_state === 'CAF D COACH',
            console.log(education.education)
          )
        ]
      }
      if (CAFCCoach) {
        ff = [
          ...ff,
          ...data.data.paylaod.filter(
            (education) => education.educational_state === 'CAF C Coach',
            console.log(education.education)
          )
        ]
      }
      if (CAFBCoach) {
        ff = [
          ...ff,
          ...data.data.paylaod.filter(
            (education) => education.educational_state === 'CAF B Coach',
            console.log(education.education)
          )
        ]
        // console.log(education.education);
      ...
      if (CAFACoach) {
        ff = [
          ...ff,
          ...data.data.paylaod.filter(
            (education) => education.educational_state === 'CAF A Coach',
            console.log(education.education)
          )
        ]
        // console.log(education.education);
      ...
      if (CAFPROCoach) {
        ff = [
          ...ff,
          ...data.data.paylaod.filter(
            (education) => education.educational_state === 'CAF Pro Coach',
            console.log(education.education)
          )
        ]
        // console.log(education.education);
        ...
        <div className='bg-white   p-7 shadow-lg rounded-lg'>
          <div className='my-2'>
            ...
            <div className='px-2 py-2 my-4 border rounded-md shadow-sm flex space-x-2 w-fit mb-8'>
              <Checkbox onChange={(e) => handleFirstLevel()}>
                First Level
              </Checkbox>
              ...
              <Checkbox onChange={(e) => handleCAFCCOACH()}>
                CAF C COACH
              </Checkbox>

              <Checkbox onChange={(e) => handleCAFBCOACH()}>
                CAF B COACH
              </Checkbox>
              <Checkbox onChange={(e) => handleCAFACOACH()}>
                CAF A COACH
              </Checkbox>
              <Checkbox onChange={(e) => handleCAFPROCOACH()}>
                CAF PRO COACH
              </Checkbox>
            </div>
          </div>
